...
public class AltaEmpleado extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        int respuesta = JOptionPane.showConfirmDialog(this, "Esta acción borrara los datos actuales. "
                + "¿Estas seguro de continuar?");
        
        if(respuesta == 0){ // Constates de clase
    ...
    private void llenarFormulario(int indice){
        if(lista.size() > 0){
            ...
            this.jTextField4.setText(String.valueOf(e.getEdad()));
            ...
            this.jTextField12.setText(String.valueOf(e.getNumeroEmpleado()));
            this.jTextField13.setText(e.getDepartamento());
            this.jTextField14.setText(String.valueOf(e.getSueldo()));
            this.jTextField15.setText(String.valueOf(e.getHorasExtra()));
